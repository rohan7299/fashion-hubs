...
class ProductModelForm(forms.ModelForm):
    ...
    productImages = forms.FileField(widget=forms.ClearableFileInput(attrs={'multiple': True}))
...
class StockModelForm(forms.ModelForm):
    ...
    #size = forms.MultipleChoiceField(choices=['M','L','XL'],widget = forms.CheckboxSelectMultiple(attrs={'class':'form-check-input'}))
